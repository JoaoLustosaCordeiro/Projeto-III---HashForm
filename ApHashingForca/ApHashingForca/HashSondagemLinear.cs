...
class HashSondagemLinear<T> : ITabelaDeHash<T> where T : IRegistro<T>, new()
{
    const int tamanhoPadrao = 10007;
    T[] tabelaDeHash;

    public HashSondagemLinear() : this(tamanhoPadrao) { }

    public HashSondagemLinear(int tamanhoDesejado)
    {
